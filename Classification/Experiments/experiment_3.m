function control = experiment_3(model,syncro,energy_umbral)
% --------------------------------------------------------------------
...
% ==================================================================================
    ...
    if  modelSelected =="general"
        ...
        % ============================== GENERAL ====================================
        name_indices='indicesTodosExp3G.mat'; 
        save('indicesTodosExp3G.mat','Location','indices','gestureLocation')
        % ============================== Check sensor placement =====================
        [~,users_good_checked,~] = Wmoos_check_sensor_placement(name_indices,'NR',syncro);
        assignin('base','users_good_checked',users_good_checked);    
        % ============================== Packing EMG Data ===========================
        fprintf('\nPacking all EMG Data ...\n');    
        ventana=180;
        [trainActivity,Ms1,Ms2,Ms3,Ms4,Ms5,Ms6,Ms7,Ms8]=Wmoos_data_union(ventana,name_indices,'C','NR');
    ...
    elseif modelSelected =="specific"  
        ...
        % ============================== SPECIFIC ===================================
        name_indices='indicesTodosExp3S.mat'; 
        save('indicesTodosExp3S.mat','Location','indices','gestureLocation')
        % ============================== Check sensor placement =====================
        [~,users_good_checked,~] = Wmoos_check_sensor_placement_training(name_indices,'NR',syncro); 
        assignin('base','users_good_checked',users_good_checked);    
        % ============================== Packing EMG Data ===========================
        fprintf('\nPacking all EMG Data ...\n');    
        ventana=180;
        [trainActivity,Ms1,Ms2,Ms3,Ms4,Ms5,Ms6,Ms7,Ms8] = Wmoos_data_union_train(ventana,name_indices,'C','NR');
        trainActivity=trainActivity';
        CellEMGDataTrain= [Ms1,Ms2,Ms3,Ms4,Ms5,Ms6,Ms7,Ms8];
        assignin('base','trainActivity',trainActivity);
        assignin('base','CellEMGDataTrain',CellEMGDataTrain);
        ...
        for i=1:(size(sEMGActivityDataRandom))*[1;0]
            ...
            dataTable=sEMGActivityDataRandom{i,2};        
                ...
                load('userData.mat')                
                if i==1
                folder=[pwd,'\','Data\Trained_Specific_Exp3','\',char(sEMGActivityDataRandom{i,1})];
                else
                folder=['Trained_Specific_Exp3','\',char(sEMGActivityDataRandom{i,1})];
                end
                mkdir (folder)
                cd (folder)
                save('userData.mat','classifierSVM','dataTable','name') 
...
% ==================================================================================
    ...
    if  modelSelected =="general"
        ...
        while testControl==true
                ...
                emgDataTested           = OfflineDataExp3G(1,20,"on"); 
    ...
    elseif modelSelected =="specific"
        ...
        addpath('Data\Trained_Specific_Exp3');
        
        
        dataPacket_aux      = orderfields(dir('Data\Trained_Specific_Exp3'));
        pathOrigin_aux      = 'Data\Trained_Specific_Exp3';
        pathUser_aux        = pwd;
        ...
        while testControl==true
            ...
            if userIndex>=3 && change_user==false
                ...
                folder_main       = 'Data\Trained_Specific_Exp3';
                ...
                emgDataTested           = OfflineDataExp3S(1,20,"on");
                emgFeatured             = getFeatures(emgDataTested);
                emgTarget               = getClassification(emgFeatured,"offline");
                emgTargetPostprocessed  = getTargetPostprocessed(emgTarget,"offline");
        ...
        fileName='responseExp3S.mat';        
        save( fileName,'response');        
        zero_analysis = start_at-150;
        WM_conversion_newFormat(fileName,zero_analysis)
        
        jsonName='responseExp3S.json';
        jsonFormat(fileName,jsonName); 
        
        exitCheck=true;
        delete(pwd,'\','indicesTodosExp3S.mat')          
