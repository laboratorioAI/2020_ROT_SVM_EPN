...
function [trainActivity,Ms1,Ms2,Ms3,Ms4,Ms5,Ms6,Ms7,Ms8] = Wmoos_data_union_train(ventana,name_indices,correctionMode,rotationMode)
        ...
        for j = 1:size_checked
            ...
            if (strcmpi(folders(i).name, users_good_checked{j,1}))
                ...
                for wm=1:WM_gestures
                    ...
                    [emg,p]=WM_Extraction_mod_train(nameUser_,wm_gesture,e_,ventana,rotationMode);
