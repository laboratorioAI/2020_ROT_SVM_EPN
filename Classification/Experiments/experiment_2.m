function control = experiment_2(model,syncro,energy_umbral)
% --------------------------------------------------------------------
...
% ==================================================================================
    ...
    if  modelSelected =="general"
        ...
        % ============================== GENERAL ====================================
        name_indices='indicesTodosExp2G.mat'; 
        save('indicesTodosExp2G.mat','Location','indices','gestureLocation')
    ...
    elseif modelSelected =="specific"  
        ...
        % ============================== SPECIFIC ===================================
        name_indices='indicesTodosExp2S.mat'; 
        save('indicesTodosExp2S.mat','Location','indices','gestureLocation')
        % ============================== Check sensor placement =====================
        ...
        for i=1:(size(sEMGActivityDataRandom))*[1;0]
            ...
            dataTable=sEMGActivityDataRandom{i,2};        
                ...
                load('userData.mat')                
                if i==1
                folder=[pwd,'\','Data\Trained_Specific_Exp2','\',char(sEMGActivityDataRandom{i,1})];
                else
                folder=['Trained_Specific_Exp2','\',char(sEMGActivityDataRandom{i,1})];
                end
                mkdir (folder)
                cd (folder)
                save('userData.mat','classifierSVM','dataTable','name') 
...
% ==================================================================================
    ...
    if  modelSelected =="general"
        ...
        while testControl==true
                ...
                emgDataTested           = OfflineDataExp2G(1,20,"off"); 
    ...
    elseif modelSelected =="specific"
        ...
        addpath('Data\Trained_Specific_Exp2');
        
        
        dataPacket_aux      = orderfields(dir('Data\Trained_Specific_Exp2'));
        pathOrigin_aux      = 'Data\Trained_Specific_Exp2';
        pathUser_aux        = pwd;
        ...
        while testControl==true
            ...
            if userIndex>=3 && change_user==false
                ...
                folder_main       = 'Data\Trained_Specific_Exp2';
                ...
                emgDataTested           = OfflineDataExp2S(1,20,"off");
                emgFeatured             = getFeatures(emgDataTested);
                emgTarget               = getClassification(emgFeatured,"offline");
                emgTargetPostprocessed  = getTargetPostprocessed(emgTarget,"offline");
        ...
        fileName='responseExp2S.mat';        
        save( fileName,'response');        
        %WM_conversion(fileName,start_at)
        zero_analysis = start_at-150;
        WM_conversion_newFormat(fileName,zero_analysis)
        
        jsonName='responseExp2S.json';
        jsonFormat(fileName,jsonName); 
        
        exitCheck=true;
        delete(pwd,'\','indicesTodosExp2S.mat')        
